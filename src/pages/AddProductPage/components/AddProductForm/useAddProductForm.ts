...
export const useAddProductForm = (onSubmit: (name: string, genre: string, developer: string,
    ...
    const submit = handleSubmit(({ name, genre, developer, label, description, price }: FormValues) =>
