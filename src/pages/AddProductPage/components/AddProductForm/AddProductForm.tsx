...
interface Props {
    onSubmit: (name: string, genre: string, developer: string,
        label: string, description: string, price: number) => void
}
    ...
    return (
        <form className={s.root} onSubmit={submit}>
            ...
            <div className={s.container}>
                ...
                <h2>Описание</h2>
                <textarea className={s.description} {...register("description")}></textarea>
                <div className={s.price}>
                    ...
                    <div>
                        <h2>Итог, ₽</h2>
                        <input className={s.input_discount} value={0} id={"input_discount"} {...register("price")}></input>
                    </div>
