...
export const Nav = observer(() => {
    const { MainPage, CatalogPage, NewsPage, SignUpPage, SignInPage } = texts.HeaderNav;
    ...
    return (
        <div className={s.root}>
            ...
            <ul className={s.user}>
                <li><Link className={s.title} key={SignInPage} to={RoutePath.SignInPage}>{SignInPage}</Link></li>
